...
async function generateModels() {
	...
	// Claude on Vertex AI. Vertex Claude IDs use the `name@YYYYMMDD` form
	// (e.g. claude-sonnet-4-5@20250929) instead of Anthropic-direct's
	// `name-YYYYMMDD`. The base URL is templated; the actual host is built
	// by @anthropic-ai/vertex-sdk from project + region at request time.
